...
public class OpenApiConfig {
	...
	private static final Map<String, ApiOperation> OPERATIONS = Map.ofEntries(
		...
		entry("BrowserIdentityController#login", operation("브라우저 로그인 및 HttpOnly 쿠키 발급", "Authentication")),
		entry("BrowserIdentityController#refresh", operation("신뢰한 Origin·CSRF 헤더 검증 후 쿠키 세션 복원·회전", "Authentication")),
		entry("BrowserIdentityController#logout", operation("브라우저 쿠키 세션 폐기", "Authentication", Access.PUBLIC, "204")),
