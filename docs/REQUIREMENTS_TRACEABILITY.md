...
| 뉴스 인텔리전스 | 영어 제목 목록, 상세 최초 번역·AI Insight, 캐시 재조회, 본문 선택 해설 | Naver 수집, 제목 번역 메모리, 온디맨드 본문·What/Why/Impact, Hana 금융 분류, K-FNSPID 영향 점수 | 수집 시 본문 미생성, 제목 25건 배치, 최초 `202`·완료 `200`, 캐시·실패·검색 요약 상태 구현 |
