...
| DART Intelligence | 영어 제목 목록, 목차·표·문단, 섹션 온디맨드 번역, 버전·원문, AI 요약·질문 | ZIP·SHA-256 카탈로그, 제목 번역 메모리, 구조화 payload, 공시별 HALFVEC 한글 검색·영어 답변 | RAG 격리·인용·거절과 고유 제목 백필 완료. 섹션 온디맨드 번역 캐시는 구현 예정 |
